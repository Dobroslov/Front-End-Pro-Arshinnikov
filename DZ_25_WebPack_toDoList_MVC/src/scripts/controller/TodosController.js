...
export default class TodosController {
  ...
  initView($el) {
    ...
    this.todosView = new TodosView($el, {
      // объект для хранения ссылок для событий удаления, добавления элементов и тогла. Это способ связи между разными классами
  ...
  addTodo(todoItem) {
    return this.todosCollection.addTodo(todoItem).then(() => this.renderList());
  }
